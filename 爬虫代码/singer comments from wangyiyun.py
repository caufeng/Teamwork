...
def artist_id():
    ...
    data = {
        "params": "uAE0hN7yRCy+plWTUJw7imQQW+wUSFRuVlFD8UTgXNfJTVLzNyqfnLRqSByCjs40san8rbwMfpasdpJRNit6vKkbQE0F7MZEgRPgSEVfXrHIB/wGiyYQ/VIaZnyTql1m",
...
def anyone():
    ...
    for artist in id_list:
        f = open("网易云评论"+str(j+1)+".csv", "w", encoding="utf-8") #爬取网易云歌手热门歌曲的评论
        total = 0
        f.write( artist["name"] + "热门歌曲以及评论数："+"\n")
